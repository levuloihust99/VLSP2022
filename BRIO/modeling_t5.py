...
class T5Scorer(T5PreTrainedModel):
    """Almost the same as T5ForConditionalGeneration but use with multiple decoder_input_ids."""
    ...
    def forward(
        ...
        if self.is_scoring_mode:
            ...
            hidden_states = torch.repeat_interleave(hidden_states, cand_num, dim=0) # [bsz * num_cands, encoder_seq_len]
